...
#define LIGHTSENSOR_Digital_PIN GPIO_PIN_2
#define LIGHTSENSOR_Analog_Pin GPIO_PIN_3

/* 对应 ADC 通道（PA3 -> ADC_CHANNEL_3 for STM32F1） */
#define LIGHTSENSOR_ADC_CHANNEL ADC_CHANNEL_3
