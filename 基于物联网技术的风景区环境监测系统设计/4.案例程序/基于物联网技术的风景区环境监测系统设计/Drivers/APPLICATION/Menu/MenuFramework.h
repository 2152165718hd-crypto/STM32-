...
#define MF_ANIM_SPEED         0.45f /**< 光标动画插值速度 (0~1)           */
#define MF_ANIM_SNAP_DISTANCE 0.5f  /**< 光标接近目标时直接吸附的距离      */
#define MF_CURSOR_PADDING     1    /**< 方框光标内边距 (像素)             */
#define MF_LINE_BUF_SIZE      48   /**< 行渲染文本缓冲区大小             */
...
/**
 * @brief  查询当前是否仍有菜单光标动画未完成
 * @retval 1 表示还需要继续渲染下一帧, 0 表示当前位置已经稳定
 */
