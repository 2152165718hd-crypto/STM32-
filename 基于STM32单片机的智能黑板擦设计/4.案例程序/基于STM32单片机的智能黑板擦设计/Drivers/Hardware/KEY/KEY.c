...
static KeyState_t s_keys[5] = {
    ...
    {KEY_MOTOR_PORT, KEY_MOTOR_PIN, 0u, 0u, 0u},
};
...
void Key_Init(void)
{
    ...
    HAL_GPIO_Init(KEY_MOTOR_PORT, &GPIO_InitStruct);
...
void Key_TimerCallback(TIM_HandleTypeDef *htim)
{
    ...
    static const KeyEvent_t evMap[5] = {KEY_UP, KEY_DOWN, KEY_ENTER, KEY_BACK, KEY_MOTOR};
