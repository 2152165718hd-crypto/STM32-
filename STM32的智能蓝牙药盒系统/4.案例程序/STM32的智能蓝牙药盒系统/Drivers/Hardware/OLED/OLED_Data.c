...
const ChineseCell_t OLED_CF16x16[] = {
	...
	},
	{
		"\xE8\x8F\x9C", /* 菜 */
		{
			...
			0x04, 0x0C, 0x15, 0x24, 0x24, 0x44, 0x40, 0x00
		}
	},
	{
		"\xE5\x8D\x95", /* 单 */
	...
	},
	{
		"\xE4\xBC\xA0", /* 传 */
		{
			0x00, 0x80, 0x60, 0xF8, 0x07, 0x40, 0x48, 0x48,
			0xE8, 0x5F, 0x48, 0x48, 0x48, 0x40, 0x40, 0x00,
			0x01, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x02, 0x0B,
			0x12, 0x22, 0xD2, 0x0A, 0x06, 0x00, 0x00, 0x00
		}
	},
	{
		"\xE6\x84\x9F", /* 感 */
	...
	},
	{
		"\xE7\xAE\xA1", /* 管 */
		{
			0x88, 0x64, 0x23, 0xA2, 0xA6, 0xAA, 0xA2, 0xBA,
			0xA4, 0xA3, 0xA2, 0x26, 0x2A, 0xA2, 0x62, 0x00,
			0x00, 0x00, 0x00, 0xFF, 0x4A, 0x4A, 0x4A, 0x4A,
			0x4A, 0x4A, 0x4B, 0xF8, 0x00, 0x00, 0x00, 0x00
		}
	},
	{
		"\xE7\x90\x86", /* 理 */
	...
	},
	{
		"\xE5\xBF\x97", /* 志 */
		{
			0x08, 0x08, 0x88, 0x88, 0x88, 0x88, 0x88, 0xFF,
			0x88, 0x88, 0x88, 0x88, 0x88, 0x08, 0x08, 0x00,
			0x40, 0x38, 0x00, 0x00, 0x3C, 0x40, 0x40, 0x42,
			0x4C, 0x40, 0x40, 0x70, 0x04, 0x08, 0x30, 0x00
		}
	},
	{
		"\xE5\x85\x89", /* 光 */
	...
	},
	{
		"\xE7\x85\xA7", /* 照 */
		{
			0x00, 0xFE, 0x42, 0x42, 0x42, 0xFE, 0x00, 0x42,
			0xA2, 0x9E, 0x82, 0xA2, 0xC2, 0xBE, 0x00, 0x00,
			0x80, 0x6F, 0x08, 0x08, 0x28, 0xCF, 0x00, 0x00,
			0x2F, 0xC8, 0x08, 0x08, 0x28, 0xCF, 0x00, 0x00
		}
	},
	{
		"\xE6\xB8\xA9", /* 温 */
	...
	},
	{
		"\xE9\x99\x90", /* 限 */
		{
			...
			0x20, 0x03, 0x0C, 0x14, 0x22, 0x41, 0x40, 0x00
		}
	},
	{
		"\xE4\xB8\x8B", /* 下 */
	...
	},
	{
		"\xE6\x9C\x8D", /* 服 */
		{
			0x00, 0x00, 0xFE, 0x22, 0x22, 0x22, 0xFE, 0x00,
	...
	},
	{
		"\xE8\x8D\xAF", /* 药 */
		{
			0x04, 0x84, 0x44, 0x34, 0x04, 0x8F, 0x04, 0x84,
			0x74, 0x4F, 0x44, 0x44, 0x44, 0xC4, 0x04, 0x00,
			0x49, 0xC9, 0x4D, 0x2B, 0x29, 0x28, 0x01, 0x00,
			0x02, 0x0C, 0x40, 0x80, 0x40, 0x3F, 0x00, 0x00
		}
	},
	{
		"\xE6\xAE\xB5", /* 段 */
	...
	},
	{
		"\xE7\xA7\x92", /* 秒 */
		{
			0x24, 0x24, 0xA4, 0xFE, 0x23, 0x22, 0x00, 0xC0,
			0x38, 0x00, 0xFF, 0x00, 0x08, 0x10, 0x60, 0x00,
			0x08, 0x06, 0x01, 0xFF, 0x01, 0x06, 0x81, 0x80,
			0x40, 0x40, 0x27, 0x10, 0x0C, 0x03, 0x00, 0x00
		}
	},
	{
		"\xE5\x8E\x86", /* 历 */
	...
	},
	{
		"\xE9\xA3\x8E", /* 风 */
		{
			...
			0x0C, 0x30, 0x00, 0x0F, 0x30, 0x40, 0xF8, 0x00
		}
	},
	{
		"\xE6\x89\x87", /* 扇 */
		{
			...
			0x00, 0x21, 0x15, 0x49, 0x81, 0x7F, 0x00, 0x00
		}
	},
	{
		"\xE6\x8C\x87", /* 指 */
		{
			0x10, 0x10, 0x10, 0xFF, 0x10, 0x90, 0x00, 0x3F,
			0x48, 0x48, 0x44, 0x44, 0x44, 0x42, 0x70, 0x00,
	...
	},
	{
		"\xE6\x92\xAD", /* 播 */
		{
			0x10, 0x10, 0xFF, 0x10, 0x90, 0x82, 0x56, 0x3A,
			0x12, 0x7F, 0x11, 0x39, 0x55, 0x90, 0x80, 0x00,
			0x42, 0x82, 0x7F, 0x01, 0x00, 0x00, 0xFF, 0x49,
			0x49, 0x7F, 0x49, 0x49, 0xFF, 0x00, 0x00, 0x00
		}
	},
	{
		"\xE6\x8A\xA5", /* 报 */
	...
	},
	{
		"\xE6\x95\xB4", /* 整 */
		{
			0x04, 0x74, 0xD4, 0x54, 0xFF, 0x54, 0xD4, 0x74,
			0x14, 0x08, 0x77, 0x84, 0x44, 0x3C, 0x04, 0x00,
			0x82, 0x89, 0x88, 0xE8, 0x8B, 0x88, 0x88, 0xF9,
			0xA8, 0xAA, 0xA9, 0xA8, 0xA9, 0x8A, 0x82, 0x00
		}
	},
	{
		"\xE7\xA1\xAE", /* 确 */
	...
	},
	{
		"\xE8\xBF\x94", /* 返 */
		{
			0x40, 0x40, 0x42, 0xCC, 0x00, 0x00, 0xFC, 0x24,
	...
	},
	{
		"\xE5\x9B\x9E", /* 回 */
		{
			0x00, 0x00, 0xFE, 0x02, 0x02, 0xF2, 0x12, 0x12,
	...
	},
	{
		"\xE5\x89\x82", /* 剂 */
		{
			0x84, 0x94, 0x54, 0x25, 0x26, 0x54, 0x4C, 0x84,
			0x04, 0x00, 0xF8, 0x00, 0x00, 0xFF, 0x00, 0x00,
			0x80, 0x60, 0x1F, 0x00, 0x00, 0x00, 0xFF, 0x00,
	...
	},
	{
		"\xE5\x81\x8F", /* 偏 */
		{
			0x80, 0x60, 0xF8, 0x07, 0x00, 0xFC, 0x24, 0x24,
			0x25, 0x26, 0x24, 0x24, 0x24, 0x3C, 0x00, 0x00,
			0x00, 0x00, 0xFF, 0x40, 0x3C, 0x03, 0xFF, 0x09,
			0x7F, 0x09, 0x7F, 0x09, 0x89, 0xFF, 0x00, 0x00
		}
	},
	{
		"\xE4\xBD\x8E", /* 低 */
	...
	},
	{
		"\xE6\x9A\x82", /* 暂 */
		{
			0x82, 0x9A, 0x96, 0x93, 0xFA, 0x52, 0x52, 0x80,
			0x7E, 0x12, 0x12, 0x12, 0xF1, 0x11, 0x10, 0x00,
			0x00, 0x01, 0x00, 0xFE, 0x93, 0x92, 0x93, 0x92,
			0x92, 0x92, 0x92, 0xFE, 0x03, 0x00, 0x00, 0x00
		}
	},
	{
		"\xE6\x97\xA0", /* 无 */
	...
	},
	{
		"\xE5\x89\xA9", /* 剩 */
		{
			0x48, 0x4A, 0xFA, 0x0A, 0xFE, 0x09, 0xF9, 0x49,
			0xA8, 0x00, 0x00, 0xF0, 0x00, 0x00, 0xFF, 0x00,
			0x22, 0x11, 0x0B, 0x04, 0xFF, 0x04, 0x09, 0x12,
			0x23, 0x00, 0x00, 0x0F, 0x40, 0x80, 0x7F, 0x00
		}
	},
	{
		"\xE4\xBD\x99", /* 余 */
		{
			...
			0x44, 0x48, 0x50, 0x20, 0x40, 0x80, 0x80, 0x00,
			0x00, 0x40, 0x22, 0x1A, 0x02, 0x42, 0x82, 0x7F,
			0x02, 0x02, 0x02, 0x0A, 0x12, 0x60, 0x00, 0x00
		}
	},
	{
		"\xE5\xB7\xB2", /* 已 */
		{
			0x00, 0x00, 0xE2, 0x82, 0x82, 0x82, 0x82, 0x82,
			0x82, 0x82, 0x82, 0xFE, 0x00, 0x00, 0x00, 0x00,
	...
	},
	{
		"\xE5\x8F\xAF", /* 可 */
		{
			0x00, 0x02, 0x02, 0xF2, 0x12, 0x12, 0x12, 0xF2,
			0x02, 0x02, 0x02, 0xFE, 0x02, 0x02, 0x02, 0x00,
			0x00, 0x00, 0x00, 0x0F, 0x04, 0x04, 0x04, 0x0F,
	...
	},
	{
		"\xE6\x81\xA2", /* 恢 */
		{
			0x00, 0xE0, 0x00, 0xFF, 0x10, 0x20, 0x08, 0x88,
			0x78, 0x0F, 0x08, 0xE8, 0x08, 0x08, 0x88, 0x00,
			0x01, 0x00, 0x00, 0xFF, 0x00, 0x10, 0x0C, 0x83,
			0x44, 0x23, 0x18, 0x07, 0x18, 0x62, 0x81, 0x00
		}
	},
	{
		"\xE5\xA4\x8D", /* 复 */
	...
	},
	{
		"\xE9\x99\x85", /* 际 */
		{
			0x00, 0xFE, 0x22, 0x5A, 0x86, 0x00, 0x20, 0x22,
			0x22, 0x22, 0xE2, 0x22, 0x22, 0x22, 0x20, 0x00,
			0x00, 0xFF, 0x04, 0x08, 0x07, 0x10, 0x0C, 0x03,
	...
	},
	{
		"\xE9\x94\xAE", /* 键 */
		{
			0x40, 0x30, 0xEF, 0x24, 0x24, 0x80, 0xE4, 0x9C,
	...
	},
	{
		"\xE5\x91\xBD", /* 命 */
		{
			0x40, 0x40, 0x20, 0x20, 0x10, 0x28, 0x24, 0x23,
			0x24, 0x28, 0x10, 0x20, 0x20, 0x40, 0x40, 0x00,
			0x00, 0x00, 0x3F, 0x11, 0x11, 0x11, 0x3F, 0x00,
			0xFF, 0x01, 0x11, 0x21, 0x1F, 0x00, 0x00, 0x00
		}
	},
	{
		"\xE4\xBB\xA4", /* 令 */
	...
	},
	{
		"\xE9\xA1\xB5", /* 页 */
		{
			0x00, 0x02, 0x02, 0xF2, 0x12, 0x1A, 0x16, 0xD2,
			0x12, 0x12, 0x12, 0xF2, 0x02, 0x02, 0x00, 0x00,
			0x00, 0x80, 0x80, 0x4F, 0x40, 0x20, 0x18, 0x07,
			0x08, 0x10, 0x20, 0x4F, 0x80, 0x00, 0x00, 0x00
		}
	},
	{
		"\xE6\x9D\xA1", /* 条 */
		{
			0x80, 0x90, 0x90, 0x48, 0x4C, 0x57, 0x24, 0xE4,
			0x24, 0x54, 0x4C, 0x44, 0x80, 0x80, 0x80, 0x00,
			0x00, 0x42, 0x22, 0x12, 0x0A, 0x42, 0x82, 0x7F,
			0x02, 0x02, 0x0A, 0x12, 0x22, 0x42, 0x00, 0x00
		}
	},
	{
		"\xE5\x85\xA8", /* 全 */
		{
			...
			0x44, 0x44, 0x44, 0x44, 0x40, 0x40, 0x00, 0x00
		}
	},
	{
		"\xE9\x83\xA8", /* 部 */
	...
	},
	{
		"", /* ???? */
		{
			0xFF, 0x01, 0x01, 0x01, 0x31, 0x09, 0x09, 0x09,
			0x09, 0x89, 0x71, 0x01, 0x01, 0x01, 0x01, 0xFF,
			0xFF, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x96,
