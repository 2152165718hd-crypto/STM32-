...
void Key_Init(void)
{
    /* Enable GPIO ports and release JTAG pins used by keys. */
    __HAL_RCC_AFIO_CLK_ENABLE();
    __HAL_AFIO_REMAP_SWJ_NOJTAG();

    Key_EnableGPIOClock(KEY_UP_PORT);
    Key_EnableGPIOClock(KEY_DOWN_PORT);
    Key_EnableGPIOClock(KEY_ENTER_PORT);
    Key_EnableGPIOClock(KEY_BACK_PORT);
