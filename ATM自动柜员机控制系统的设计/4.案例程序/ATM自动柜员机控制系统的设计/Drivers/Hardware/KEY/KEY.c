...
void Key_Init(void)
{
    ...
    htim_key.Instance = KEY_SCAN_TIM_INSTANCE;
    htim_key.Init.Prescaler = KEY_SCAN_TIM_PRESCALER;
    htim_key.Init.CounterMode = TIM_COUNTERMODE_UP;
    htim_key.Init.Period = KEY_SCAN_TIM_PERIOD;
    htim_key.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;
    htim_key.Init.AutoReloadPreload = TIM_AUTORELOAD_PRELOAD_DISABLE;
