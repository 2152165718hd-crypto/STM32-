...
/* ==================== 管理者密码配置 ==================== */
#define APP_PWD_MAX_LEN 6        /* 密码最大位数 */
#define APP_PWD_DEFAULT "123456" /* 默认密码 */
#define APP_DOUBLE_CLICK_MS 400  /* 双击检测时间窗口 ms */
#define APP_ONENET_REPORT_INTERVAL_MS 2000U /* OneNET 物模型固定上报周期 */
#define APP_ONENET_PENDING_RETRY_MS 200U    /* 待补发上报重试间隔 */
