...
/* User config */
#define OLED_USE_HARDWARE_I2C 1 /* 1: hardware I2C, 0: software I2C */
#define OLED_USE_DMA 0          /* ADC1 DMA uses DMA1_Channel1, keep OLED on blocking I2C */
#define OLED_DMA_TRANSPORT_MODE 0 /* 0: DMA memory transport + blocking I2C (stable), 1: I2C DMA transport */
#define OLED_ENABLE_DIFF_UPDATE 0 /* 1: update changed bytes only, 0: always refresh requested area */
